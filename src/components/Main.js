			...
			<div>
				<Carousel fade={true} controls={false}>
					...
					<Carousel.Item interval={1000}>
						{/* <div style={{ backgroundImage: `url("https://images.unsplash.com/photo-1506993708131-b0bf29d16b76?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80")`, backgroundRepeat: 'no-repeat' }}></div>
						<background-image
